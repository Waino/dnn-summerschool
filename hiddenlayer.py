...
class HiddenLayer(object):
    def __init__(self, rng, inpt, n_in, n_out, W=None, b=None,
        ...
        :type inpt: theano.tensor.dmatrix
        :param inpt: a symbolic tensor of shape (n_examples, n_in)
        ...
        if b is None:
            ...
            b = theano.shared(value=b_values, name='b_hidden', borrow=True)

        self.W = W
        self.b = b

        lin_output = T.dot(inpt, self.W) + self.b
        self.output = (
...
class MLP(object):
    ...
    def __init__(self, rng, inpt, n_in, n_hidden, n_out):
        ...
        # of the hidden layer
        self.softmaxLayer = softmax.SoftmaxLayer(
            inpt=self.hiddenLayer.output,
            n_in=n_hidden,
            n_out=n_out
        )
...
class DNN(object):
    """Like the Multi-Layer Perceptron above,
    ...
    def __init__(self, rng, inpt, n_in, n_hidden, n_out):
        ...
        self.hiddenLayers = []
        output_of_previous = inpt
        size_of_previous = n_in
        ...
        self.softmaxLayer = softmax.SoftmaxLayer(
            inpt=self.hiddenLayers[-1].output,
            n_in=n_hidden[-1],
            n_out=n_out
        )
